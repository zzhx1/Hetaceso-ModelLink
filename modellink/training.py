...
from modellink import get_tensorboard_writer
from modellink import get_current_global_batch_size
from modellink import get_num_microbatches
from modellink import is_last_rank
from modellink import update_num_microbatches
from modellink import print_rank_0
from modellink import print_rank_last
...
from modellink.optimizer import get_megatron_optimizer
from modellink.initialize import initialize_megatron
from modellink.initialize import write_args_to_tensorboard
from modellink.learning_rates import AnnealingLR
from modellink.model import DistributedDataParallel as LocalDDP
from modellink.utils import check_adlr_autoresume_termination
from modellink.utils import unwrap_model
from modellink.data.data_samplers import build_pretraining_data_loader
from modellink.utils import calc_params_l2_norm
from modellink.utils import report_memory, throughput_calculator, checkpoint_throughput_calculator
from modellink.model.transformer import ParallelTransformerLayer
from modellink.model.lora_utils import is_enable_lora, handle_model_with_lora, get_lora_model_classes
from modellink.core.pipeline_parallel.schedules import forward_backward_pipelining_with_foldx_fifo
from modellink.core.pipeline_parallel.schedules import forward_backward_pipelining_with_foldx_aiao
from modellink.core.pipeline_parallel.schedules import get_forward_backward_func, get_forward_func
from modellink.core.memory.auto_recomputing.autorecompute import autorecompute_profile
...
def pretrain(train_valid_test_dataset_provider,
    ...
    print_rank_0('time to initialize modellink (seconds): {:.3f}'.format(
        time.time() - _TRAIN_START_TIME))
    print_datetime('after modellink is initialized.')
...
def setup_model_and_optimizer(model_provider_func,
    ...
    if args.deepspeed:
        ...
        if args.data_efficiency_curriculum_learning and build_train_valid_test_datasets_provider is not None:
            train_ds = None
            # Only need to build dataset on tp rank 0 since modellink has the
