...
class FlashSelfAttention(torch.nn.Module):   #Ascend Flash Attention, support Alibi
    ...
    def forward(self, q, k, v, pse=None):
        ...
        size_record = q.shape
        if self.alibi is not None and pse is None and (
                self.alibi.matmul_result is None or self.alibi.output_size != size_record):
    ...
    def get_alibi(self, layer_number):
        args = get_args()
