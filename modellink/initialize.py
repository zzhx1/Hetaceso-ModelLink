...
from modellink import get_adlr_autoresume
from modellink import get_args
from modellink import get_tensorboard_writer
from modellink.core import tensor_parallel
from modellink.arguments import parse_args, validate_args
from modellink.utils import is_rank_0
from modellink.core import parallel_state
from modellink.global_vars import set_global_variables
from modellink.core.parallel_state import (set_tensor_model_parallel_rank,
...
def initialize_megatron(extra_args_provider=None, args_defaults=None,
    ...
    `allow_no_cuda` should not be set unless using modellink for cpu only
